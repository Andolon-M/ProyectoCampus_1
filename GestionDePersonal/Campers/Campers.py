...
def menu():
    ...
    while True:
        ...
        opcion = int(input("\n------Ingrese una opcion: "))
        if opcion == 1:
            nuevoCamper=pedirCamper()
            if nuevoCamper != None:
                ControllerCampers.agregarCamper(nuevoCamper)
            else:
            ...
            ControllerCampers.buscarCamper(buscar)
            time.sleep(1)
            mostrarMenu()
            pass
        elif opcion == 3:
            ControllerCampers.mostrarCampers()
...
def mostrarMenu():
    ...
    print("\n*****************************************************************************************************")
    print("Modulo para la gestion de Campers")
    print("-- -- -- -- -- -- -- -- -- -- -- --")
    print("\n1. Registrar Un Camper")
    print("2. Buscar Un Camper")
    print("3. Mostrar Todos los campers")
    print("4. Regresar")
